        ...
        try (BufferedReader r = resource(name)) {
            ...
            while ((line = r.readLine()) != null) {
                ...
                if (matcher.matches()) {
                    ...
                    final TestData testData = new TestData(lineNo, line, input, expected, flags);
                    if (!testData.isSkipComments() && !testData.isReadComments()) {
                        // Skip this because of different capabilities
                        data.add(testData);
                    }
                }
            }
